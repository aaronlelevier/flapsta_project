...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Star'
        db.create_table(u'products_star', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vote', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('product_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'products', ['Star'])


    def backwards(self, orm):
        # Deleting model 'Star'
        db.delete_table(u'products_star')
