...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.UPC'
        db.delete_column(u'products_product', 'UPC')

        # Adding field 'Product.ASIN'
        db.add_column(u'products_product', 'ASIN',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.UPC'
        db.add_column(u'products_product', 'UPC',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.ASIN'
        db.delete_column(u'products_product', 'ASIN')
    ...
    models = {
        ...
        u'products.product': {
            'ASIN': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'Meta': {'ordering': "('title',)", 'object_name': 'Product'},
            'SKU': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'available': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
