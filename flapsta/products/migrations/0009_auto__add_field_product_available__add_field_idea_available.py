...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products_product', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Idea.available'
        db.add_column(u'products_idea', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'products_product', 'available')

        # Deleting field 'Idea.available'
        db.delete_column(u'products_idea', 'available')
